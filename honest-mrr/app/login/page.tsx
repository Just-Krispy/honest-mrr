    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-purple-950 to-slate-950 flex items-center justify-center p-4">
      <div className="w-full max-w-md space-y-6">
        ...
        <Link href="/" className="flex items-center justify-center gap-2">
          ...
          <span className="text-2xl font-bold text-white">Honest MRR</span>
        </Link>
          ...
          <CardHeader className="text-center">
            ...
            <CardDescription className="text-slate-400">
              {mode === 'login'
                ...
                : 'Sign up to start generating verified screenshots'}
            </CardDescription>
          </CardHeader>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    className="w-full pl-10 pr-4 py-3 bg-slate-800 border border-slate-700 rounded-lg text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"
                  />
                </div>
              </div>
